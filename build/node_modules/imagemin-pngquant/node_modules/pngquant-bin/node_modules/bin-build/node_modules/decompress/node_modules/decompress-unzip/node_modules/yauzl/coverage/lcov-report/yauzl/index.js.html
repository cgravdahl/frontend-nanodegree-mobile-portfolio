<!doctype html><html lang=en><head><title>Code coverage report for yauzl/index.js</title><meta charset=utf-8><link rel=stylesheet href=../prettify.css><style>
        body, html {
            margin:0; padding: 0;
        }
        body {
    ...
    </style></head><body><div class="header high"><h1>Code coverage report for <span class=entity>yauzl/index.js</span></h1><h2>Statements: <span class=metric>88.7% <small>(212 / 239)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class=metric>70.93% <small>(61 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class=metric>92.86% <small>(26 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class=metric>97.09% <small>(200 / 206)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class=metric><span class=ignore-none>none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;</h2><div class=path><a href=../index.html>All files</a> &#187; <a href=index.html>yauzl/</a> &#187; index.js</div></div><div class=body><pre><table class=coverage>
...
function open(path, options, callback) {
  ...
  <span class=missing-if-branch title="else path not taken">E</span>if (options == null) options = {autoClose: true};
  <span class=missing-if-branch title="if path not taken">I</span>if (callback == null) <span class=cstat-no title="statement not covered">callback = defaultCallback;</span>
...
<span class=cstat-no title="statement not covered">    options = null;</span>
  ...
  <span class=missing-if-branch title="if path not taken">I</span>if (options == null) <span class=cstat-no title="statement not covered">options = {autoClose: false};</span>
  <span class=missing-if-branch title="if path not taken">I</span>if (callback == null) <span class=cstat-no title="statement not covered">callback = defaultCallback;</span>
...
function ZipFile(fdSlicer, cdOffset, fileSize, entryCount, comment, autoClose) {
  ...
  self.fdSlicer.on("error", <span class=fstat-no title="function not covered">function(err) {</span>
    // error closing the fd
<span class=cstat-no title="statement not covered">    emitError(self, err);</span>
  });
...
ZipFile.prototype.close = function() {
  <span class=missing-if-branch title="if path not taken">I</span>if (!this.isOpen) <span class=cstat-no title="statement not covered">return;</span>
  this.isOpen = false;
  this.fdSlicer.unref();
};
&nbsp;
function emitErrorAndAutoClose(self, err) {
  <span class=missing-if-branch title="else path not taken">E</span>if (self.autoClose) self.close();
  emitError(self, err);
}
function emitError(self, err) {
  <span class=missing-if-branch title="if path not taken">I</span>if (self.emittedError) <span class=cstat-no title="statement not covered">return;</span>
...
function readEntries(self) {
  ...
  readFdSlicerNoEof(self.fdSlicer, buffer, 0, buffer.length, self.readEntryCursor, function(err) {
    <span class=missing-if-branch title="if path not taken">I</span>if (err) <span class=cstat-no title="statement not covered">return emitErrorAndAutoClose(self, err);</span>
    <span class=missing-if-branch title="if path not taken">I</span>if (self.emittedError) <span class=cstat-no title="statement not covered">return;</span>
    var entry = new Entry();
...
<span class=cstat-no title="statement not covered">        return emitErrorAndAutoClose(self, e);</span>
      }
&nbsp;
      // 46+n - Extra field
...
ZipFile.prototype.openReadStream = function(entry, callback) {
  var self = this;
  <span class=missing-if-branch title="if path not taken">I</span>if (!self.isOpen) <span class=cstat-no title="statement not covered">return callback(new Error("closed"));</span>
...
<span class=cstat-no title="statement not covered">    return setImmediate(<span class=fstat-no title="function not covered">function() {</span> <span class=cstat-no title="statement not covered">callback(null, new Buffer(0)); </span>});</span>
  }
  fdSlicer.read(buffer, offset, length, position, function(err, bytesRead) {
    <span class=missing-if-branch title="if path not taken">I</span>if (err) <span class=cstat-no title="statement not covered">return callback(err);</span>
    <span class=missing-if-branch title="if path not taken">I</span>if (bytesRead &lt; length) <span class=cstat-no title="statement not covered">return callback(new Error("unexpected EOF"));</span>
    callback();
  });
}
&nbsp;
...
function defaultCallback(err) {
  <span class=missing-if-branch title="if path not taken">I</span>if (err) <span class=cstat-no title="statement not covered">throw err;</span>
}
&nbsp;</pre></td></tr>
</table></pre></div><div class=footer><div class=meta>Generated by <a href="http://istanbul-js.org/" target=_blank>istanbul</a> at Wed Dec 03 2014 16:28:28 GMT-0700 (MST)</div></div><script src=../prettify.js></script><script src=https://yui-s.yahooapis.com/3.6.0/build/yui/yui-min.js></script><script>
